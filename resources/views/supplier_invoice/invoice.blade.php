...
<div style="display: flex;">
    <address style="width: 60%">
        <p  style="margin-bottom: 16px;"> الاسم: {{$invoice->supplier->name}} </p>
        <p class="" style="margin-bottom: 19px;line-height: 23px"> العنوان: {{$invoice->supplier->address}}  </p>
        <p class="" > الهاتف: {{$invoice->supplier->phone}} </p>
    </address>
    ...
    <table class="balance">
        ...
        <tr>
            ...
            <td style="color: #0a58ca;font-size: 13px"><span>{{$invoice->total-$invoice->payed}}</span><span
