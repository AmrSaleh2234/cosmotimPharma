...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            <li class="side-item side-item-category"> برنامج ادارة <span class="text-primary">cosmotim</span></li>
            <li class="slide">
                @if( Auth::guard("admin")->check())
                    <a class="side-menu__item" href="{{ url('/' . $page='admin') }}">
                        ...
                        <span class="side-menu__label">الرئيسية</span><span class="badge badge-success side-badge">1</span></a>
                @else
                    <a class="side-menu__item" href="{{ url('/' . $page='customer') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                            <path d="M0 0h24v24H0V0z" fill="none"/>
                            <path d="M5 5h4v6H5zm10 8h4v6h-4zM5 17h4v2H5zM15 5h4v2h-4z" opacity=".3"/>
                            <path
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . $page='customer_invoice') }}">قائمة فواتير
                            المبيعات </a></li>
                    <li><a class="slide-item" href="{{ url('/' . $page='supplier_invoice') }}">قائمة فواتير
                            المشتريات </a></li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ url('/' . $page='inventory') }}"
                           style="@if( Auth::guard("web")->check()) display:none @endif">قائمة المخزن</a></li>
                    <li><a class="slide-item" href="{{ url('/' . $page='customer') }}">قائمة العملاء</a></li>
                    <li><a class="slide-item" href="{{ url('/' . $page='supplier') }}"
                           style="@if( Auth::guard("web")->check()) display:none @endif">قائمة موردين</a></li>
                    ...
                    <li><a class="slide-item" href="{{ url('/' . $page='gift') }}">قائمة الهدايا </a></li>
                    <li><a class="slide-item" href="{{ url('/' . $page='employee') }}">قائمة الموظفين </a></li>
                </ul>
            </li>
