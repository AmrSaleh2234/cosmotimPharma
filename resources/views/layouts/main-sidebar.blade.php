			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='customer_invoice') }}">قائمة فواتير المبيعات </a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='supplier_invoice') }}">قائمة فواتير المشتريات </a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='inventory') }}" style="@if( Auth::guard("web")->check()) display:none @endif" >قائمة المخزن</a></li>
