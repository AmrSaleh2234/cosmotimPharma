            ...
            <div class="card" style="border-top:3px solid cadetblue">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h3 class="card-title mg-b-0">تعديل الموظف </h3>
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0"  class="form-control" name="balance"  value="{{$employee->start_balance}}">
                                </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" min="100" class="form-control" name="salary" value="{{$employee->salary*1}}">
                                </div>
                                <div class="form-group">
                                    <label>يوم الراتب</label>
                                    <input type="number"  class="form-control" name="salary_day" value="{{$employee->salary_day}}">
                                </div>
