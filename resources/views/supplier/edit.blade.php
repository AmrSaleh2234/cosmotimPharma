                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row mg-t-10">
                                        <div class="col-lg-3">
                                            <label class="rdiobox"><input name="balance_status" type="radio" @if($supplier->start_balance_status ==1) checked @endif value="1">
                                                <span>مدين (عليه)</span></label>
                                        </div>
                                        <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                                            <label class="rdiobox"><input name="balance_status"   type="radio" @if($supplier->start_balance_status ==2) checked @endif value="2">
                                                <span>متزن</span></label>
                                        </div>
                                        <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                                            <label class="rdiobox"><input name="balance_status" type="radio" @if($supplier->start_balance_status ==3) checked @endif value="3">
