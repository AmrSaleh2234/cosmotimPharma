...
module.exports = function(Chart) {
	...
	Chart.layoutService = {
		...
		update: function(chart, width, height) {
			...
			// We may be adding some padding to customer for rotated x axis labels
		...
		fit: function() {
			...
			if (tickOpts.display && display) {
				...
				if (isHorizontal) {
					...
					// dominant factor here, so get that length first and customer for padding
					if (tickOpts.mirror) {
						largestTextWidth = 0;
					} else {
...
module.exports = function(Chart) {
	...
	var LinearRadialScale = Chart.LinearScaleBase.extend({
		...
		getDistanceFromCenterForValue: function(value) {
			...
			// Take into customer half font size + the yPadding of the top value
